...
**Integrantes: Leonardo Mamede e Letícia**
...
**Pontuação atribuída:** \___8__ / 8

**Justificativa**: O código está modularizado organizado em pasta componentes.
...
**Pontuação atribuída:** \___7__ / 8

**Justificativa: Implementar skip-link em próximas atualizações.**
...
**Pontuação atribuída:** \__8_\__ / 8

**Justificativa**: O site está responsivo e funcionando corretamente.
...
**Justificativa**: O site e a identidade visual do site lembram uma empresa de lava-jato.
...
Critério 1: Colocar Skip-link

Ação para melhorar: Acessibilidade
